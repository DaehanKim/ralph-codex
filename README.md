...
Original author and source: [snarktank/ralph](https://github.com/snarktank/ralph).
...
# Codex uses AGENTS.md and does not require an additional prompt file
...
Run Codex harness smoke tests (Codex-only; no local Amp/Claude installation required):
